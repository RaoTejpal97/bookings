...
// Reservation is the handler for the reservation page and display the reservation form
...
// Availablity renders the search availablity page
func (m *Repository) Availablity(w http.ResponseWriter, r *http.Request) {
	render.RenderTemplate(w, r, "search-availability.page.html", &models.TemplateData{})
}

// PostAvailablity renders the search availablity page
func (m *Repository) PostAvailablity(w http.ResponseWriter, r *http.Request) {
	start := r.Form.Get("start")
	end := r.Form.Get("end")

	w.Write([]byte(fmt.Sprintf("start date is %s adn end is %s", start, end)))
}
...
// AvailablityJSON handles request for availablity and sends JSON response
